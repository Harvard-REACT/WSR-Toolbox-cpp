...
# rsync --ignore-existing up12@192.168.1.43:~/WSR_Project/WSR-Toolbox-cpp/data/online_data/* $3
rsync --ignore-existing $1@$2:~/WSR_Project/WSR-Toolbox-cpp/data/online_data/* $3
...
../wsr_build/remote_processing $3 $4 1
